...
public class ishwargonj_3 extends AppCompatActivity {

    ImageView back;
    LottieAnimationView call_1,call_2,call_3,call_4;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_ishwargonj3);
